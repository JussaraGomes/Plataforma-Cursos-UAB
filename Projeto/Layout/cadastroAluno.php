            ...
            <form class="form-horizontal" id="formulario" action="Acoes/Cadastro.php" method="POST" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input type="number" id="cpfAluno" class="form-control form-control-lg" required="required">
					</div>
					<div class="col-md-6 form-group">
				...
				<div class="row">
					<div class="col-12">
						<input type="submit" name="cadastrar_aluno" value="Cadastrar Aluno" class="btn btn-primary btn-lg px-5" disabled>
					</div>
				</div>
			</form>
        </div>
