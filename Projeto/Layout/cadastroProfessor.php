            ...
            <form class="form-horizontal" id="formulario" action="Acoes/Cadastro.php" method="POST" enctype="multipart/form-data">
				...
				<div class="row"> 
					<div class="col-md-6 form-group">
						...
						<input type="text" id="nomeProfessor" class="form-control form-control-lg">
					</div>
					<div class="col-md-6 form-group">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input type="number" id="cpfProfessor" class="form-control form-control-lg">
					</div>
					<div class="col-md-6 form-group">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input type="email" id="emailProfessor" class="form-control form-control-lg">
					</div>
					<div class="col-md-6 form-group">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input type="password" id="senhaProfessor" class="form-control form-control-lg">
					</div>
					<div class="col-md-6 form-group">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input type="password" id="senhaRepetidaProfessor" class="form-control form-control-lg">
					</div>
					<div class="col-md-6 form-group">
