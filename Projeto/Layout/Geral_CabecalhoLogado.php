      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            ...
            <a href="#" class="small mr-3"><span class="icon-phone2 mr-2"></span> <?php echo $plataforma->getPrimeiroTelefone();?></a> 
            <a href="#" class="small mr-3"><span class="icon-envelope-o mr-2"></span> <?php echo $plataforma->getEmail();?></a> 
          </div>
          <div class="col-lg-3 text-right">
            <a href="login.html"    class="small mr-3">SAIR&nbsp;&nbsp;<span class="icon-share"></span></a>
