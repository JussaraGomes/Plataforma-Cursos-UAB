...
class Questoes_Prova {
    ...
    public function setPerguntaQuestao($perguntaQuestao) {
        $this->perguntaQuestao = $perguntaQuestao;
    }
    ...
    public function setAlternativaIncorreta1($alternativaIncorreta1) {
        $this->alternativaIncorreta1 = $alternativaIncorreta1;
    }

    public function setAlternativaIncorreta2($alternativaIncorreta2) {
        $this->alternativaIncorreta2 = $alternativaIncorreta2;
    }

    public function setAlternativaIncorreta3($alternativaIncorreta3) {
        $this->alternativaIncorreta3 = $alternativaIncorreta3;
    }

    public function setAlternativaIncorreta4($alternativaIncorreta4) {
        $this->alternativaIncorreta4 = $alternativaIncorreta4;
    }
